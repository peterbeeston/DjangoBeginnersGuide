...
class NewTopicTests(TestCase):
    ...
    def test_new_topic_invalid_post_data(self):
        '''
        Invalid post data should not be redirected
    ...
    def test_new_topic_invalid_post_data_empty_fields(self):
        ...
        The expected behavior is to show the form again with violation errors
        '''
        url = reverse('new_topic', kwargs={'pk': 1})
        data = {
            'subject': '',
...
class LoginRequiredNewTopicTests(TestCase):
    def setUp(self):
        Board.objects.create(name="Test Board", description="a board for testing.")
